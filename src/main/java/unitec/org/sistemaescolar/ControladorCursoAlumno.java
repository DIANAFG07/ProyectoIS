...
public class ControladorCursoAlumno {
    ...
    @CrossOrigin
    @RequestMapping(value = "/curso-alumno", method = RequestMethod.GET, headers = {"Accept=application/json"})
    ...
    @CrossOrigin
    @RequestMapping(value = "/curso-alumno/{id}", method = RequestMethod.GET, headers = {"Accept=application/json"})
    ...
    @CrossOrigin
    @RequestMapping(value = "/curso-alumno", method = RequestMethod.POST, headers = {"Accept=application/json"})
    ...
    @CrossOrigin
    @RequestMapping(value = "/curso-alumno", method = RequestMethod.PUT, headers = {"Accept=application/json"})
    ...
    @CrossOrigin
    @RequestMapping(value = "/curso-alumno/{id}", method = RequestMethod.DELETE, headers = {"Accept=application/json"})
